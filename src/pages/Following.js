          ...
          props.myFollowingList.map((following, i) => {
            return (
              <div style={{marginBottom:"15px", display:"flex", alignItems:"center"}} key={i}>
                  ...
                  <span style={{margin:"0 10px 0 30px", fontSize:"17px", flex:"1", textAlign:"center", cursor:"pointer"}} onClick={() => {nav(`/myPage/${following.id}`); props.onHide();}}>{following.nickname}</span>
